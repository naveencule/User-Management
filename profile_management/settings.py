...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'userprofiles', 'templates')],  # Add your templates directory here
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
LOGIN_REDIRECT_URL = 'profile_view'  # Redirect to profile view after login
